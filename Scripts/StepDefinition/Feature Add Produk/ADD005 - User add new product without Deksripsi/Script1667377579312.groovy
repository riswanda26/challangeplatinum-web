...
WebUI.callTestCase(findTestCase('Pages/SellHomepage/Input Nama Produk'), [('NamaProduk') : 'Mie Ayam '], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/SellHomepage/Input Harga Produk'), [('HargaProduk') : '15000'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/SellHomepage/Verify New Product'), [('NewProduct') : 'Mie Ayam'], FailureHandling.STOP_ON_FAILURE)
